...
module.exports.welcome = async(iswel, isleft, juna, anu) =>{
    ...
    var wc = await getBuffer(`https://telegra.ph/file/697c616f84f510e573f19.jpg`)
                	await juna.sendMessage(anu.id, {image: wc, caption: `*Hii* @${num.split("@")[0]},*welcome to* ${groupName} *jangan Lupa Intro!* \n${groupDesc}`, mentions: [num]}, {quoted:fkontaku})
                }
   ...
   var lf = await getBuffer(`https://telegra.ph/file/bedd6b2d0c425f949148f.jpg`) 
